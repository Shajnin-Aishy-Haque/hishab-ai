      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col">
          ...
          <div
            ...
            title={isDriveConnected ? 'Google Drive auto-sync is active' : 'Click to sync or connect Google Drive'}
          >
            {isDriveConnected ? (
            ...
            <span
              className={`w-1.5 h-1.5 rounded-full ${
                isDriveConnected ? 'bg-emerald-500 animate-pulse' : 'bg-emerald-400'
              }`}
            ></span>
          </div>
        </div>
